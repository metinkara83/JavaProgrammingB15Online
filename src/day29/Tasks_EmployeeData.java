...
public class Tasks_EmployeeData {
...
//        TASK 1. Print all job titles - hint ( substring, indexOf)
        ...
        for (String eachEmployee : employees) {
            System.out.println(eachEmployee.substring(eachEmployee.indexOf("[")+1, eachEmployee.lastIndexOf("]")));
        }

//        TASK 2: Print all FirstName-lastName jobTitle

        for (String eachEmployee : employees) {
            System.out.println(eachEmployee.split(" ")[0]+"-"+eachEmployee.split(" ")[1]+" "+(eachEmployee.substring(eachEmployee.indexOf("[")+1, eachEmployee.lastIndexOf("]"))));
        }
...
//      TASK 3. Look for those 2 people in the array and assert below data
        ...
        for (String eachEmployee : employees) {
            if (eachEmployee.contains("Tracy Bartle")){
                if (eachEmployee.contains("Geological Engineer")){
            ...
            if (eachEmployee.contains("Skipper Abrahamsson")){
                if (eachEmployee.contains("Financial Advisor")){
...
//        for (String eachEmployee : employees) {
//            System.out.println(eachEmployee.split(" ")[0].charAt(0)+""+eachEmployee.split(" ")[1].charAt(0)+" -> "+(eachEmployee.substring(eachEmployee.indexOf("[")+1, eachEmployee.lastIndexOf("]"))));
//        }
        ...
        for (int i = 0; i < employees.length ; i++) {
            ...
            String lastName = firstLast.substring(firstLast.lastIndexOf(" ")+1);
            System.out.println(firstName.charAt(0)+""+lastName.charAt(0)+" -> "+employees[i].substring(employees[i].indexOf("[")+1, employees[i].lastIndexOf("]")));
        }
    }
}
        /*
