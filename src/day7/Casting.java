...
public class Casting {
    ...
    public static void main(String[] args) {
        ...
        //int 10 is implicitly (automatically) converted to double 10.0 and stored inside bigNum behind scene
        double bigNum = 10;
        ...
        int earthToMoonInInt = (int) earthToMoon;
        System.out.println(earthToMoonInInt);
