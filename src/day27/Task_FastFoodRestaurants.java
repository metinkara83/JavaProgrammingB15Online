...
public class Task_FastFoodRestaurants {
...
//        }
        ...
        for (int k = 0; k < restaurants.length ; k++) {
            if (restaurants[k].contains("popeyes")){
                ++popeyesCount;
            }
            else if (restaurants[k].contains("dominos")){
                ++dominosCount;
            }
            else if (restaurants[k].contains("tacobell")){
                ++tacoBellCount;
            }
        }
         ...
         */
        int mcDonaldsTX = 0;
        for (int l = 0; l < restaurants.length; l++) {
            if (restaurants[l].contains("mcdonalds") && restaurants[l].contains("TX")){
                ++mcDonaldsTX;
                System.out.println(mcDonaldsTX+". "+restaurants[l]);
            }
        }
                ...
                String[] splittedRest;
                for (int m = 0; m < restaurants.length ; m++) {
                    splittedRest = restaurants[m].split(",");
                    System.out.println(splittedRest[2]+" -> "+splittedRest[1]+", "+splittedRest[4]);
        }
    }
}
