package selfPracticeTests.repl236;
    /**
...
//                (word.substring(0,1).toUpperCase()+word.substring(1,word.indexOf(" ")).toLowerCase()+" "+word.substring(word.indexOf(" ")+1,word.indexOf(" ")+2).toUpperCase()+word.substring(word.indexOf(" ")+2).toLowerCase());
            }
            return "";
        }
        ...
        public void setAuthor(String author) {
            ...
            if (author.isEmpty()){
                ...
                for (int i = 0 ; i < splitted.length; i++){
                    if (isTitleWord(splitted[i])){
                        t += capitalize(splitted[i]);
