...
public class ExceptionPractice2 {
    ...
    public static void main(String[] args) {
        ...
        // we want to take different action according to different type of exception happen during the program
        // we can have more than one catch block to handle different types of exception
